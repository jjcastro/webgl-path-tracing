...
function readNumber(rgbString) {
  var arr = [
    parseInt(rgbString.substring(1, 3), 16),
    parseInt(rgbString.substring(3, 5), 16),
    parseInt(rgbString.substring(5, 7), 16)
  ];
  return arr.map(function(d) { return d / 255.0 }).join();
}
